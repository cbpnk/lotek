...
<aside class="top">
  <div class="form-horizontal">
    <div class="form-group">
      ...
      <div class="column">
        <label class="form-label">${ (vnode.attrs.doc.feishu__revision_n || [0])[0] }</label>
      </div>
      <div>
...
<div style="grid-column: 1 / span 3; margin: 1em;">
  <iframe style="margin: 0 auto; width: 100%; height: 100%;" src=${ EDITOR_URL + m.buildPathname("/docs/:token", {token: vnode.attrs.doc.feishu__token_i[0]}) }></iframe>
</div>`;
    }
}
